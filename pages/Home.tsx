      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl animate-fadeIn py-20">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6">
            <Link
              to="/portfolio"
              className="w-full sm:w-auto px-10 md:px-12 py-4 md:py-5 bg-white text-black text-xs md:text-sm font-black rounded-full transition-all hover:bg-brand-purple hover:text-white shadow-2xl shadow-white/10"
            >
              EXPLORE THE VAULTS
            </Link>
            <Link
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {[
            ...
            <Link
              to={pillar.link}
              key={idx}
              className="p-8 md:p-10 bg-muted rounded-3xl border border-white/5 hover:border-brand-purple/50 transition-all group flex flex-col h-full hover:-translate-y-2"
            >
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((t, idx) => (
              <div key={idx} className="bg-primary p-10 rounded-[2rem] border border-white/5 relative group">
